...
public class InFixExpression {
     ...
     * 
     * Current operators supported: +,-,/,*,() and ^ Variables are also
     * supported, prefixed by $ to use variables, a {@link VariableProvider}
     * must be provided at evaluation time.
     * 
     * @param expr
     */
    ...
    private static boolean comparePrecedence(char top, char p_2) {
        ...
        /*
         * if (top == '+' && p_2 == '*') // + has lower precedence than * return
         * false;
         * 
         * if (top == '*' && p_2 == '-') // * has higher precedence over -
         * return true;
         * 
         * if (top == '+' && p_2 == '-') // + has same precedence over + return
         * true;
         * 
         * return true;/*
         */
     ...
     * 
     * @param provider
     *            provider to use for resolving variables.
     * @return
     */
    public int getValue(VariableProvider provider) {
        Stack<Integer> stack = new Stack<Integer>();
        for (String exp : this.expr) {
            int i = 0;
            switch (exp.charAt(0)) {
            case '+':
                i = stack.pop();
            ...
            case '^':
                i = stack.pop();
                stack.push((int) Math.pow(stack.pop(), i));
                break;
