//TODO : Fix in future? or move to Gson style?
//package com.tehbeard.utils.bukkit.misc;
//
...
//
///**
// * The Standard Item Syntax. This class is built to be able to survive on its
// * own, without CraftBook.
// * 
// * @author Me4502
// * 
// */
...
//     * 
//     * @param item
//     *            The {@link ItemStack} to convert into a {@link String}.
...
//                        builder.append("/potion:").append(eff.getType().getName()).append(";")
//                                .append(eff.getDuration()).append(";").append(eff.getAmplifier());
//                    }
//                }
...
//                try {
//                    try {
//                        Object itemType = Class.forName("com.sk89q.worldedit.blocks.ItemType")
//                                .getMethod("lookup", String.class).invoke(null, dataSplit[0]);
//                        id = (Integer) itemType.getClass().getMethod("getID").invoke(itemType);
//                        if (id < 1) {
//                            id = 1;
//                        }
//                    } catch (Exception eee) {
//                        Object blockType = Class.forName("com.sk89q.worldedit.blocks.BlockType")
//                                .getMethod("lookup", String.class).invoke(null, dataSplit[0]);
